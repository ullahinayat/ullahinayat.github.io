...
$featurearray = array("Geschlecht" => array("männlich","weiblich"),"Parlamentsmitglied seit" => array("zwei Jahren","sechs Jahren","vierzehn Jahren","zehn Jahren"),"Partei" => array("CDU/CSU","SPD","FDP","B90/Grüne","AfD","Die Linke"),"Motivation für Kandidatur" => array("um die Interessen der einfachen Leute zu repräsentieren","um der eigenen Partei zu dienen","um selbst Einfluss auf die politischen Entscheidungen zu nehmen"),"Fehltage im Bundestag meistens aufgrund von" => array("Veranstaltungen und Treffen auf EU-Ebene","Veranstaltungen und Treffen in Berlin","Veranstaltungen und Treffen im Wahlkreis"),"Am meisten Kenntnis von Problemen und Herausforderungen" => array("im Wahlkreis","in der nationalen Politik","in der europäischen Politik"),"Engagement in der Reform der Eurozone" => array("gar nicht","wenig","viel"));

$restrictionarray = array(array(array("Partei","AfD"),array("Parlamentsmitglied seit","sechs Jahren")),array(array("Partei","AfD"),array("Parlamentsmitglied seit","vierzehn Jahren")),array(array("Partei","AfD"),array("Parlamentsmitglied seit","zehn Jahren")));
